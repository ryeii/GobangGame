...
/**
 * Created by Ryan An
 * Date: 2020/7/4 12:25 下午
 */
public class Gobang {

    public double celllen = 50;

    /**
     * Grid dimensions of Gobang Game
     */
    private int XGrid;
    private int YGrid;

    /**
     * Current player conducting action in this round:
     *     true == black chess playing
     *     false == white chess playing
     */
    private boolean currentPlayer;

    /**
     * Chess data in 2*2 array
     *     0 == no chess in this location
     *     1 == black chess in this location
     *     2 == white chess in this location
     */
    private int[][] chess;
